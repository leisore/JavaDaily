...
public class SID {
	...
	public static void main(String[] args) throws Exception {
		//System.out.println(computeDefaultSUID(A.class));
		/*
		A a = new A();
		a.setA(10);
		a.setB(20);
	...
	private static long computeDefaultSUID(Class<?> cl) {
		...
		try {
			...
			for (int i = 0; i < fieldSigs.length; i++) {
				...
				int mods = sig.member.getModifiers() & (Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED
